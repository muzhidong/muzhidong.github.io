...
## 编程范式
- 命令式编程：关注怎么做，其核心是步骤和状态
  - 面向过程编程
  - 函数式编程FP：无副作用，适合分布式计算集群的应用场景，但过度使用会导致可读性稍弱差、学习难度大（掌握λ演算、代数、范畴学等基础）
  - 面向对象编程OOP：通过继承解决纵向的代码重复问题
...
- 声明式编程：关注做什么，核心是目标和结果，如SQL、HTML、CSS。它们的特点是不必创建变量存储数据，也不包含循环控制语法如for、while
