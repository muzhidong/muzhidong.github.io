...
|-------|---------|----------|
| Chrome | WebKit(旧)/Blink(新) | V8 |
| Safari | WebKit | JavaScriptCore | 
| Edge | EdgeHTML(旧，Trident分支)/Blink(新) | Chakra(旧)/V8(新) |
| FireFox | Gecko | SpiderMonkey |
| Opera | Presto(旧)/Blink(新) | LinearA、LinearB、Futhark、Carakan(旧)/V8(新) | 
| IE | Trident(MSHTML) | JScript(旧)/Chakra(新) |
...
- *[CSS属性在各大渲染引擎上的性能表现](https://css-triggers.com/)，[原版](https://csstriggers.com/)
