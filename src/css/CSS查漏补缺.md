...
> 彩蛋：[CSS在线生成器](https://css-generators.com/)，支持自定义边框、边角、提示、分割线、渐变阴影、背景、Loading、各种图形等，非常强大！
...
- 字体变量设置。指定要改变特征的4个字母组成的轴名称和对应值，提供对可变字体(只有使用不少于两种的字体变体，如不同字重、斜体/非斜体组合，才有可变字体一说)特征的低级控制
- 取值
